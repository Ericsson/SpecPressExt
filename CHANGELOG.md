...
- **SpecPress update** - Inherit latest SpecPress library version which by default embeds images in BASE64 encoding into exported HTML files instead of a separate "media" folder.
